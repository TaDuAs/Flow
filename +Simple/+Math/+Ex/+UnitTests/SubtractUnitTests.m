...
disp('Starting Simple.Math.Ex.Subtract class unit tests');
%%
test = Simple.UnitTests.UnitTesting('Simple.Math.Ex.Subtract.ctor');
...
%%
test = Simple.UnitTests.UnitTesting('Simple.Math.Ex.Subtract.equals');
...
test.evaluateAllExpectations();
%%
test = Simple.UnitTests.UnitTesting('Simple.Math.Ex.Subtract.invoke');
...
test.evaluateAllExpectations();
%%
test = Simple.UnitTests.UnitTesting('Simple.Math.Ex.Subtract.derive');
