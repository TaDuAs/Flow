...
% 
% MXML.save('filePath/fileName.xml', data, [meta])
%           saves to xml formatted file
% MXML.save('filePath/fileName.json', data, [meta])
%           saves to json formatted file
% MXML.save('filePath/fileName.notXmlNorJson', data, [meta])
%           saves to xml formatted file
% MXML.save(filename, data, format)
%           saves to file according to specified format ('xml' or 'json')
% MXML.save(filename, data, meta, format)
%           saves to file according to specified format ('xml' or 'json')
%
% Author: TADA
