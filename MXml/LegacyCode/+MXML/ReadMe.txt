...
MXML.Factory.instance - Class factory singleton instance
MXML.Factory.terminate - Clears class factory instance from all registered Ctors, Good for when a refresh of the factory is needed
MXML.Factory.init(factoryInitializer) - Initializes the class factory using a factoryInitializer object which has a method with the signature: initFactory(factory);
