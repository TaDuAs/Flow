classdef OneWayBinderTests < matlab.unittest.TestCase & mvvm.providers.IModelProvider
    ...
    methods (Test)
        function bindAllHandlesPath(testCase)
            bnd = mvvm.OneWayBinder('child1.child1.child1', testCase.gui.txt, 'String', 'Event', 'Callback', 'ModelProvider', testCase);
        ...
        function bindHandleValueHandle(testCase)
            bnd = mvvm.OneWayBinder('child2.child1.child2', testCase.gui.txt, 'String', 'Event', 'Callback', 'ModelProvider', testCase);
        ...
        function binderIsKeptAliveByBindingManager(testCase)
            ...
            binder = mvvm.OneWayBinder('child1.child1.child2', testCase.gui.txt, 'String', 'BindingManager', bm, 'ModelProvider', testCase);
        ...
        function bindToEmptyPropertyThenPopulateIt(testCase)
            ...
            % modelPath, control, property, event, modelProvider
            binder = mvvm.OneWayBinder('child1.id', testCase.gui.txt, 'String', 'BindingManager', bm, 'ModelProvider', testCase);
                        
            testCase.model.child1 = mvvm.tests.HandleModel('345');
            
            assert(...
                isequal('345', testCase.gui.txt.String), ...
                'OneWayBinder should have created the binding once child1 was set', ...
        ...
        function bindAllHandlesPath_NumericIndexer(testCase)
            bnd = mvvm.OneWayBinder('child1.child1.list', testCase.gui.txt, 'String', 'ModelProvider', testCase, 'Indexer', {[1 2]});
        ...
        function bindAllHandlesPath_NumericIndexer2(testCase)
            bnd = mvvm.OneWayBinder('child1.child1.list', testCase.gui.txt, 'String', 'ModelProvider', testCase, 'Indexer', {[1 3 9]});
        ...
        function bindAllHandlesPath_2DNumericIndexer(testCase)
            bnd = mvvm.OneWayBinder('child1.child1.list', testCase.gui.txt, 'String', 'ModelProvider', testCase, 'Indexer', {1, [1 3 9]});
        ...
        function bindAllHandlesPath_StringIndexerColon(testCase)
            bnd = mvvm.OneWayBinder('child1.child1.list', testCase.gui.txt, 'String', 'ModelProvider', testCase, 'Indexer', {':'});
        ...
        function bindAllHandlesPath_LogicalIndexer(testCase)
            bnd = mvvm.OneWayBinder('child1.child1.list', testCase.gui.txt, 'String', 'ModelProvider', testCase, 'Indexer', {[true(1,2), false(1,7)]});
        ...
        function guiDoesntUpdatesModel(testCase)
            % modelPath, control, property, event, modelProvider
            binder = mvvm.OneWayBinder('child1.child1.child2', testCase.gui.txt, 'String', 'Event', 'Action', 'ModelProvider', testCase);
        ...
        function oneWayAdaptationBinding(testCase)
            ...
            % modelPath, control, property, event, modelProvider
            binder = mvvm.OneWayBinder('child1.id', testCase.gui.txt, 'String', @(s) [s ' added text'], 'BindingManager', bm, 'ModelProvider', testCase);
